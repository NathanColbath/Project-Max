...
public class EnemySpawner : MonoBehaviour
{
    ...
    private Vector3 randomPointInCircle(float radius)
    {
        ...
        Vector3 randomDir = Quaternion.Euler(0.0f, 0.0f, Random.Range(0,360)) * Vector2.right * radius + transform.position;

        Vector3 toReturn = new Vector3(randomDir.x, 0.0f, randomDir.z);
